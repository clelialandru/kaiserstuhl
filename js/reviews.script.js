...
function startAutoSlide() {
    autoSlideInterval = setInterval(nextTestimonial, 10000); // 5s
}
...
function handleTouchSwipe() {
    const swipeThreshold = 50; // Sensitvité au slide
...
function showTestimonial(index) {
    ...
    // uMet à jour la position de la slide
